...
- **Fix ImageKit (A47)** : recette F1 → 500 sur `imagekit-auth` → paquet `imagekit@1.5.0` = SDK 2016 ; → 6.0.0 exact (racine + trip-service), d.ts maison supprimée, copie imbriquée dédupliquée, `uploadDetailed` + erreurs explicites, photos 10 Mo. **trip-service à relancer.**
