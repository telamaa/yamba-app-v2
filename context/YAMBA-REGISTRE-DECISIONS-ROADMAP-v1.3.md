...
## 2bis.8 — Sessions B3-PR1 (transport, serveur) et B3-PR2 (front) — A38→A43
...
| ✅ | **B3 transport** — PR1 serveur ✅ **#95** (D42/D43, A38–A42) : `POST /deals/:id/pickup` · `/pickup/refuse` · `/events` · `/code/regenerate` · `/deliver`, code bcrypt + AES révélé dans la vue Shipper, 4 emails B3, seed avec vrais codes · PR2 front ✅ **#96** (A43 : bascule des 4 mocks Voyageur + régénération Expéditeur, upload ImageKit) — **B3 SOLDÉ** le 02/09 |
