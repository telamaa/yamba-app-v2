...
| 🟡 | **B3 transport** — PR1 serveur (D42/D43, A38–A41) : `POST /deals/:id/pickup` · `/pickup/refuse` · `/events` · `/code/regenerate` · `/deliver`, code bcrypt + AES révélé dans la vue Shipper, 4 emails B3, seed avec vrais codes · PR2 front (bascule des 4 mocks Voyageur + régénération Expéditeur, upload ImageKit) | PR1 en cours (02/09) |
