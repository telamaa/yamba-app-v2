...
| Indicateur | Valeur |
|---|---|
| Tests (plateforme) | 838 = trip 209 · deal 494 · notification 99 · message 36 (+ auth-service 142, check CI « Tests unitaires (auth-service) ») |
| Décisions au registre | D1 → D67 + D35 gravée (+ arbitrages A1 → A143) |
