...
| 🔄 **B4 — argent sortant** : **PR1 serveur FAITE** (`feat/b4-payout-server`, D49–D52, A65–A70 : confirm, dispute — aussi depuis PICKED_UP après 48 h —, cron J+4 + rejeu + rappel J+3, `PaymentProvider.transfer` avec `source_transaction`, `Dispute`, 5 emails D44) → PR2 front Expéditeur → PR3 front Voyageur → `feat/b4-late-cancel-payout` (retenue ANN-01 au prorata, D50) | 🔄 (PR1 mergée #127) | D49–D52, INV-2…5 |
