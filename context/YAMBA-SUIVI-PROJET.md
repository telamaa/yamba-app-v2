...
| Indicateur | Valeur |
|---|---|
| Tests (plateforme) | 834 = trip 209 · deal 494 · notification 95 · message 36 (+ auth-service 103, check CI « Tests unitaires (auth-service) ») |
| Décisions au registre | D1 → D64 + D35 gravée (+ arbitrages A1 → A143) |
