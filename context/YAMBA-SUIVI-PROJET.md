...
| C · `feat/c7a-admin-search-exports` — **D60 2A, A126–A128** : filtres serveur, tri, curseur (utilisateurs, trajets, billets, à arbitrer), exports CSV journalisés (opérationnels ids seulement ; nominatif SUPER_ADMIN + motif), lib `@packages/libs/csv`, bouton d'export encadré ; auth 103 · trip 209 · deal 478 | 🔄 PR ouverte |
...
| Indicateur | Valeur |
|---|---|
| Tests (plateforme) | 765 = trip 209 · deal 478 · notification 78 (+ auth-service 103, check CI « Tests unitaires (auth-service) ») |
| Décisions au registre | D1 → D60 (+ arbitrages A1 → A128) |
