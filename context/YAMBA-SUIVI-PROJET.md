...
| F · `fix/messaging-quick-reply-draft` — **A142** : la réponse rapide remplit la zone de saisie sans envoyer (RG-FCH-23), suppression d'un message non retenue (RG-FCH-24) ; front seul | 🔄 PR ouverte |
