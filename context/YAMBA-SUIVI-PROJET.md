...
### État au 3 septembre 2026 · #116 `fix/auth-recette` (à fusionner) + `feat/email-locale` en PR (D44/D45 implémentées, A55–A57) · 610 tests plateforme (trip 187 · deal 355 · notification 68) + 59 auth-service · `main` = `9c6e155` (#88)
...
| Décisions au registre | D1 → D45 (+ arbitrages A1 → A57) |
