...
| F · `feat/f2-messaging-front` — **D61 / A135–A136** : messagerie du tableau de bord (liste, fil, rendez-vous, réponses rapides, numéro), bulle du header réelle, i18n `messaging` FR/EN, sondage adaptatif 3 s / 20 s, notification in-app (second consumer, topic et groupe dédiés) ; notification 83 | 🔄 PR ouverte |
