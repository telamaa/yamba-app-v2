...
| Indicateur | Valeur |
|---|---|
| Tests (plateforme) | 755 = trip 202 · deal 475 · notification 78 (+ auth-service 89, check CI « Tests unitaires (auth-service) ») |
| Décisions au registre | D1 → D58 (+ arbitrages A1 → A116) |
