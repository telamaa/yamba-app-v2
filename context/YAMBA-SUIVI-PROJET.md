...
| Indicateur | Valeur |
|---|---|
| Tests (plateforme) | 700 = trip 198 · deal 424 · notification 78 (+ auth-service 80, check CI « Tests unitaires (auth-service) ») |
| Décisions au registre | D1 → D54 (+ arbitrages A1 → A101) |
