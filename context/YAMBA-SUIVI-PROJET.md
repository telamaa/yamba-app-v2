...
| Indicateur | Valeur |
|---|---|
| Tests (plateforme) | 772 = trip 209 · deal 485 · notification 78 (+ auth-service 103, check CI « Tests unitaires (auth-service) ») |
| Décisions au registre | D1 → D60 (+ arbitrages A1 → A131) |
