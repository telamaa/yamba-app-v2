...
| Indicateur | Valeur |
|---|---|
| Tests (plateforme) | 838 = trip 209 · deal 494 · notification 99 · message 36 (+ auth-service 138, check CI « Tests unitaires (auth-service) ») |
| Décisions au registre | D1 → D66 + D35 gravée (+ arbitrages A1 → A143) |
...
4. Jalon 2 : ~~admin-ui (C)~~ **SOLDÉ le 05/09** · reste : Sentry/PostHog, provider email (D35), sessions (SES-04/05), chantier E profil public, moniteur externe de disponibilité (candidat D64), TrustScore D29-2 — **constitutif du lancement**.
