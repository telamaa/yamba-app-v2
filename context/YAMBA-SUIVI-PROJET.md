...
| Indicateur | Valeur |
|---|---|
| Tests (plateforme) | 822 = trip 209 · deal 494 · notification 83 · message 36 (+ auth-service 103, check CI « Tests unitaires (auth-service) ») |
| Décisions au registre | D1 → D63 (+ arbitrages A1 → A143) |
