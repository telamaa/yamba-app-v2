...
| Indicateur | Valeur |
|---|---|
| Tests (plateforme) | 762 = trip 207 · deal 477 · notification 78 (+ auth-service 94, check CI « Tests unitaires (auth-service) ») |
| Décisions au registre | D1 → D59 (+ arbitrages A1 → A119) |
