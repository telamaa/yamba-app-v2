...
| Lancement · `feat/e-profile-editable` — **D67** (chantier E) : profil tenu par le membre — `GET/PATCH /auth/me/profile`, avatar ImageKit `/avatars` (`fileId` gardé, ancien fichier supprimé, URL vérifiée), règle pure (noms 2–40, ≥ 16 ans, champs Voyageur), `profilePublic` (404 aux autres, `hidden` pour soi), `showCity`, écran Profil réel + « Voir mon profil public », slug immuable ; auth 142 | 🟡 PR ouverte |
