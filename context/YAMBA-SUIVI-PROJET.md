...
| Copie · `chore/vocabulaire-voyageur` — **A90** : « Voyageur » (FR) / « Traveler » (EN) à la place de Yamber / Tripper dans toute l'interface (57 valeurs, 11 fichiers, 8 chaînes de code) ; identifiants et route `/become-yamber` inchangés | ✅ PR ouverte |
...
| Décisions au registre | D1 → D52 (+ arbitrages A1 → A90) |
