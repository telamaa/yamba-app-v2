...
| Indicateur | Valeur |
|---|---|
| Tests (plateforme) | 718 = trip 198 · deal 442 · notification 78 (+ auth-service 85, check CI « Tests unitaires (auth-service) ») |
| Décisions au registre | D1 → D56 (+ arbitrages A1 → A107) |
