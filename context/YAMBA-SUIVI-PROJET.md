...
| Indicateur | Valeur |
|---|---|
| Tests (plateforme) | 814 = trip 209 · deal 489 · notification 83 · message 33 (+ auth-service 103, check CI « Tests unitaires (auth-service) ») |
| Décisions au registre | D1 → D62 (+ arbitrages A1 → A142) |
