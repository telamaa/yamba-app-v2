...
### État au 2 septembre 2026 · `dev` = #100 (B3 SOLDÉ) · 601 tests · `main` = `9c6e155` (#88)
...
| **B3-PR5 (chore) — typographie des pages Deal** : H1/H2 alignés sur le dashboard (22/17 px semibold), grilles et colonne d'action dès 768 px sur les 5 pages + squelette — A46 | 🟡 PR ouverte | A46 |
...
| Décisions au registre | D1 → D43 (+ arbitrages A1 → A46) |
...
| PR mergées | #1 → #95 (#90 = pile B2-PR1/2/3 · #91 = docs post-merge · #92 = B2-PR4 emails · #93 = B2-PR5 tracker · #94 = docs post-merge · #95 = B3-PR1 serveur · #96 = B3-PR2 front · #97 = docs · #98 = B3-PR3 boîte du Voyageur · #99 = docs · #100 = B3-PR4 page demande — 13 checks comptés à chaque fois) |
