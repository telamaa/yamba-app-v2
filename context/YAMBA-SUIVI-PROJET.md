...
| Indicateur | Valeur |
|---|---|
| Tests (plateforme) | 723 = trip 202 · deal 443 · notification 78 (+ auth-service 87, check CI « Tests unitaires (auth-service) ») |
| Décisions au registre | D1 → D57 (+ arbitrages A1 → A110) |
