...
### État au 3 septembre 2026 · #116 `fix/auth-recette` (à fusionner) + #117 `feat/email-locale` (D44/D45, A55–A57) + `feat/booking-auth-modal` en PR (A58) — pile à fusionner dans l'ordre · 610 tests plateforme (trip 187 · deal 355 · notification 68) + 59 auth-service · `main` = `9c6e155` (#88)
...
| Indicateur | Valeur |
|---|---|
| Tests (plateforme) | 610 = trip 187 · deal 355 · notification 68 (+ auth-service 59, check CI « Tests unitaires (auth-service) ») |
| Décisions au registre | D1 → D45 (+ arbitrages A1 → A58) |
| Règles métier | ~50 (V2) + RG-B-01…35, RG-S-01…13, RG-C-01…16, RG-G-01…03, RG-D-01…16, RG-V-01…09, RG-F-01…06, RG-N-01…08, RG-T-01…06, RG-P-01…27, RG-A-01…08 |
