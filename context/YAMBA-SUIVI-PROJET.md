...
| Indicateur | Valeur |
|---|---|
| Tests (plateforme) | 826 = trip 209 · deal 494 · notification 87 · message 36 (+ auth-service 103, check CI « Tests unitaires (auth-service) ») |
| Décisions au registre | D1 → D64 (+ arbitrages A1 → A143) |
