...
### État au 2 septembre 2026 · `dev` = #102 (B3 SOLDÉ) · 601 tests · `main` = `9c6e155` (#88)
...
| **Fix ImageKit (A47)** : `imagekit@1.5.0` (fossile 2016) → 6.0.0, d.ts maison supprimée, copie imbriquée dédupliquée ; `uploadDetailed` + erreurs explicites, photos 10 Mo/WebP | 🟡 PR ouverte | A47 |
...
| Décisions au registre | D1 → D43 (+ arbitrages A1 → A47) |
...
| PR mergées | #1 → #95 (#90 = pile B2-PR1/2/3 · #91 = docs post-merge · #92 = B2-PR4 emails · #93 = B2-PR5 tracker · #94 = docs post-merge · #95 = B3-PR1 serveur · #96 = B3-PR2 front · #97 = docs · #98 = B3-PR3 boîte du Voyageur · #99 = docs · #100 = B3-PR4 page demande · #101 = docs · #102 = typographie Deal — 13 checks comptés à chaque fois) |
