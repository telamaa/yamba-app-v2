...
### État au 3 septembre 2026 · `dev` = `bb57c49` (#116 recette auth · #117 email-locale D44/D45 · #118 modale de réservation A58) + #119 `feat/trip-favorites` (D46, A59) + #120 `feat/auth-pages-ux` (D45, A60) + `feat/auth-google` en PR (D47, A61) · 621 tests plateforme (trip 198 · deal 355 · notification 68) + 59 auth-service · `main` = `9c6e155` (#88)
...
| Décisions au registre | D1 → D47 (+ arbitrages A1 → A62) |
