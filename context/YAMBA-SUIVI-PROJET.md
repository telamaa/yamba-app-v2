...
| CI · `chore/ci-build-i18n` — job « Build des services (webpack) » (six services) + règle « pas de point dans une clé » du script i18n ; 17 checks requis | 🔄 PR ouverte |
...
| Indicateur | Valeur |
|---|---|
| Tests (plateforme) | 805 = trip 209 · deal 485 · notification 83 · message 28 (+ auth-service 103, check CI « Tests unitaires (auth-service) ») |
| Décisions au registre | D1 → D61 (+ arbitrages A1 → A142) |
