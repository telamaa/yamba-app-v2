...
| Indicateur | Valeur |
|---|---|
| Tests (plateforme) | 693 = trip 198 · deal 417 · notification 78 (+ auth-service 65, check CI « Tests unitaires (auth-service) ») |
| Décisions au registre | D1 → D53 (+ arbitrages A1 → A94) |
