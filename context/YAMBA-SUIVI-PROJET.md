...
| C · `feat/c4-admin-trips` — **D57 / A108–A110** : file « billets à vérifier » (motifs fermés, ouverture journalisée, expiration à la lecture, redépôt), « masqué par Yamba » (champ lu par la recherche, la page publique et la réservation ; proposition Support / exécution Médiateur ; email générique ; bandeau Voyageur), liste et fiche trajet admin, KPI d'accueil par permission (`/admin/kpis`, `/home`), OpenAPI admin trip-service, seed billet ; trip 202 · deal 443 · auth 87 | 🔄 PR ouverte |
