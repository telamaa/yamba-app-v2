...
### État au 3 septembre 2026 · `dev` = `bb57c49` (#116 recette auth · #117 email-locale D44/D45 · #118 modale de réservation A58) + `feat/trip-favorites` en PR (D46, A59) · 621 tests plateforme (trip 198 · deal 355 · notification 68) + 59 auth-service · `main` = `9c6e155` (#88)
...
| Décisions au registre | D1 → D46 (+ arbitrages A1 → A59) |
| Règles métier | ~50 (V2) + RG-B-01…35, RG-S-01…13, RG-C-01…16, RG-G-01…03, RG-D-01…16, RG-V-01…09, RG-F-01…06, RG-N-01…08, RG-T-01…06, RG-P-01…27, RG-A-01…08, RG-C-17…18, RG-FAV-01…06 |
