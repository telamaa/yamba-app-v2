...
| Indicateur | Valeur |
|---|---|
| Tests (plateforme) | 716 = trip 198 · deal 440 · notification 78 (+ auth-service 80, check CI « Tests unitaires (auth-service) ») |
| Décisions au registre | D1 → D55 (+ arbitrages A1 → A104) |
