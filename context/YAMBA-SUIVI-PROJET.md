...
| Indicateur | Valeur |
|---|---|
| Tests (plateforme) | 744 = trip 202 · deal 464 · notification 78 (+ auth-service 88, check CI « Tests unitaires (auth-service) ») |
| Décisions au registre | D1 → D58 (+ arbitrages A1 → A113) |
