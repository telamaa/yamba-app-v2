...
| Indicateur | Valeur |
|---|---|
| Tests (plateforme) | 694 = trip 198 · deal 418 · notification 78 (+ auth-service 65, check CI « Tests unitaires (auth-service) ») |
| Décisions au registre | D1 → D53 (+ arbitrages A1 → A97) |
