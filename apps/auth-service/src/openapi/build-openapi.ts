  ...
  return {
    ...
    paths: {
      ...
      "/admin/admins/{id}": {
        ...
        delete: admin("admins.manage", { tags: ["admin"], summary: "Revoke the admin profiles (sessions revoked)", operationId: "revokeAdmin", parameters: [idParam("id", "User id")], responses: adminResponses({ "200": okOnly, "403": jsonResponse("ErrorResponse", "ADMIN_IS_SELF, LAST_SUPER_ADMIN (A186: no other super administrator in service), or permission"), "404": r404 }) }),
      },
