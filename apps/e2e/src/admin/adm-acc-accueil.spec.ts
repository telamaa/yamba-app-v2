...
const TUILES: Array<{ cle: string; libelle: string; section: "À traiter" | "État de la plateforme"; lien: string; permission: AdminPermission }> = [
  ...
  { cle: "suspensionProposals", libelle: "Sanctions proposées", section: "À traiter", lien: "/users?proposal=1", permission: "users.read" },
  ...
  { cle: "restrictedUsers", libelle: "Comptes restreints", section: "État de la plateforme", lien: "/users?accountStatus=RESTRICTED", permission: "users.read" },
  { cle: "suspendedUsers", libelle: "Comptes suspendus", section: "État de la plateforme", lien: "/users?accountStatus=SUSPENDED", permission: "users.read" },
