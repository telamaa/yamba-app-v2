/**
 * BookingCompletedDesktop.tsx — « Envoi terminé » (COMPLETED → VERIFIED), desktop (B4-PR2, A71)
 */
"use client";
...
export default function BookingCompletedDesktop({ booking, onCloseAction }: Props) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      <div className="mx-auto max-w-7xl px-4 pb-16 pt-4 sm:px-6 sm:pt-6">
        ...
        <CompletedBanner booking={booking} />
