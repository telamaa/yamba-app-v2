...
const TILES: Tile[] = [
  ...
  { key: "suspensionProposals", label: "Sanctions proposées", href: "/users?proposal=1", tone: "act" },
  ...
  { key: "restrictedUsers", label: "Comptes restreints", href: "/users?accountStatus=RESTRICTED", tone: "info" },
  { key: "suspendedUsers", label: "Comptes suspendus", href: "/users?accountStatus=SUSPENDED", tone: "info" },
