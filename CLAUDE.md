...
Test platform baseline: **786 tests** (trip-service 209, deal-service 485, notification-service 78, message-service 14) + auth-service 103 (also a CI check) — any deviation must be explained.
