...
Test platform baseline: **911 tests** (trip-service 231, deal-service 542, notification-service 99, message-service 39) + auth-service 215 (also a CI check) — any deviation must be explained.
