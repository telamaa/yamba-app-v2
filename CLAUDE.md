...
Test platform baseline: **872 tests** (trip-service 221, deal-service 516, notification-service 99, message-service 36) + auth-service 187 (also a CI check) — any deviation must be explained.
