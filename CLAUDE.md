...
Test platform baseline: **693 tests** (trip-service 198, deal-service 417, notification-service 78) + auth-service 65 (also a CI check) — any deviation must be explained.
