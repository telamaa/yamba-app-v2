...
Test platform baseline: **673 tests** (trip-service 198, deal-service 399, notification-service 76) + auth-service 65 (also a CI check) — any deviation must be explained.
