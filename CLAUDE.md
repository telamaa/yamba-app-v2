...
Test platform baseline: **826 tests** (trip-service 209, deal-service 494, notification-service 87, message-service 36) + auth-service 134 (also a CI check) — any deviation must be explained.
