...
Test platform baseline: **996 tests** (trip-service 261, deal-service 576, notification-service 115, message-service 44) + auth-service 229 (also a CI check) — any deviation must be explained.
