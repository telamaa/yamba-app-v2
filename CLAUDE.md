...
Test platform baseline: **886 tests** (trip-service 231, deal-service 520, notification-service 99, message-service 36) + auth-service 209 (also a CI check) — any deviation must be explained.
