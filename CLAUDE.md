...
Test platform baseline: **723 tests** (trip-service 202, deal-service 443, notification-service 78) + auth-service 87 (also a CI check) — any deviation must be explained.
