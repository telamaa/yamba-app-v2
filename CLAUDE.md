...
Test platform baseline: **860 tests** (trip-service 209, deal-service 516, notification-service 99, message-service 36) + auth-service 183 (also a CI check) — any deviation must be explained.
