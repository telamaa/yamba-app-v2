...
Test platform baseline: **621 tests** (trip-service 198, deal-service 355, notification-service 68) + auth-service 65 (also a CI check) — any deviation must be explained.
