...
Test platform baseline: **814 tests** (trip-service 209, deal-service 489, notification-service 83, message-service 33) + auth-service 121 (also a CI check) — any deviation must be explained.
