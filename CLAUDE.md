...
Test platform baseline: **990 tests** (trip-service 257, deal-service 576, notification-service 115, message-service 42) + auth-service 229 (also a CI check) — any deviation must be explained.
