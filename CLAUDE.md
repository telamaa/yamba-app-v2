...
Test platform baseline: **805 tests** (trip-service 209, deal-service 485, notification-service 83, message-service 28) + auth-service 103 (also a CI check) — any deviation must be explained.
