...
Test platform baseline: **904 tests** (trip-service 231, deal-service 538, notification-service 99, message-service 36) + auth-service 215 (also a CI check) — any deviation must be explained.
