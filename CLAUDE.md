...
Test platform baseline: **937 tests** (trip-service 231, deal-service 560, notification-service 107, message-service 39) + auth-service 215 (also a CI check) — any deviation must be explained.
