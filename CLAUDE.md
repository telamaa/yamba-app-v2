...
Test platform baseline: **772 tests** (trip-service 209, deal-service 485, notification-service 78) + auth-service 103 (also a CI check) — any deviation must be explained.
