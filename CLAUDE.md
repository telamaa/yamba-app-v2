...
Test platform baseline: **654 tests** (trip-service 198, deal-service 381, notification-service 75) + auth-service 65 (also a CI check) — any deviation must be explained.
