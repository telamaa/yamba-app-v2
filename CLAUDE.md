...
Test platform baseline: **677 tests** (trip-service 198, deal-service 402, notification-service 77) + auth-service 65 (also a CI check) — any deviation must be explained.
