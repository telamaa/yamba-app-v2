...
Test platform baseline: **744 tests** (trip-service 202, deal-service 464, notification-service 78) + auth-service 88 (also a CI check) — any deviation must be explained.
