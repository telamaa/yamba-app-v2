...
Test platform baseline: **664 tests** (trip-service 198, deal-service 390, notification-service 76) + auth-service 65 (also a CI check) — any deviation must be explained.
