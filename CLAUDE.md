...
Test platform baseline: **755 tests** (trip-service 202, deal-service 475, notification-service 78) + auth-service 89 (also a CI check) — any deviation must be explained.
