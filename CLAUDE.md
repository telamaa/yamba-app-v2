...
Test platform baseline: **653 tests** (trip-service 198, deal-service 380, notification-service 75) + auth-service 65 (also a CI check) — any deviation must be explained.
