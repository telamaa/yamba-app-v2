...
Test platform baseline: **822 tests** (trip-service 209, deal-service 494, notification-service 83, message-service 36) + auth-service 130 (also a CI check) — any deviation must be explained.
