...
export const SETTINGS_CATALOG = [
  ...
  { key: "alerts.payoutFailedHours", group: "alerts", label: "Deal terminé, versement toujours en échec depuis", description: "Heures APRÈS LA FIN DU DEAL au-delà desquelles un versement encore en échec devient une alerte. La mesure porte sur la fin du deal (l'argent dû au Voyageur est en retard), pas sur la date du premier échec (A198 c).", rule: "D59 3A · A198", unit: "hours", default: 48, min: 1, max: 336, step: 1, scope: "OPERATIONS", consumers: ["deal-service"] },
  ...
  { key: "alerts.outboxLagMinutes", group: "alerts", label: "Relais en retard depuis", description: "Minutes de retard du relais d'événements à partir desquelles une alerte est levée.", rule: "D59 3A", unit: "minutes", default: 15, min: 1, max: 1440, step: 1, scope: "OPERATIONS", consumers: ["deal-service", "auth-service"] },
