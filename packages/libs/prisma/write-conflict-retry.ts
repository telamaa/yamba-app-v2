 ...
 *
 * Recette 02-ADMIN § 5.5 (14/09) : remonté de deal-service dans `packages/libs/prisma` — deux administrateurs qui
 * lèvent la même suppression d'adresse recevaient eux aussi un 500 (auth-service). Un seul exemplaire, partagé.
 */
